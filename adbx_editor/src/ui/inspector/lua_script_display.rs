        ...
        parent.spawn((
            ...
            if let Some(state) = lua_script_state {
                ...
                let state_color = match state {
                    adbx_runtime::lua::component::LuaScriptState::Loaded => Color::srgb(0.0, 1.0, 0.0),
                    adbx_runtime::lua::component::LuaScriptState::Running => Color::srgb(0.0, 0.5, 1.0),
                    adbx_runtime::lua::component::LuaScriptState::Error => Color::srgb(1.0, 0.0, 0.0),
                };
                lua_script_editor.spawn((
                    Node {
                        flex_direction: FlexDirection::Row,
