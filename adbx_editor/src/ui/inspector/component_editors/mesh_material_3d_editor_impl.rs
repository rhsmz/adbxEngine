...
/// MeshMaterial3dエディタの実装
pub struct MeshMaterial3dEditor;

impl ComponentEditor for MeshMaterial3dEditor {
    fn draw_ui(
        &self,
        ...
        commands.entity(parent_ui).with_children(|parent: &mut ChildSpawnerCommands| {
            parent.spawn((
                ...
                Name::new("MeshMaterial3dEditor"),
                BackgroundColor(Color::srgb(0.18, 0.18, 0.18)),
            )).with_children(|material_editor: &mut ChildSpawnerCommands| {
                material_editor.spawn((
                    Node {
                        width: Val::Percent(100.0),
                        height: Val::Px(25.0),
                        padding: UiRect::all(Val::Px(5.0)),
                    ...
                    Name::new("MeshMaterial3dHeader"),
                )).with_children(|header: &mut ChildSpawnerCommands| {
                    header.spawn((
                        Text::new("Material 3D"),
                        bevy::text::TextFont {
                            font_size: 12.0,
                            ..default()
                        },
                ...
                material_editor.spawn((
                    ...
                    info.spawn((
                        Text::new("3D Material Component"),
                        bevy::text::TextFont {
                            font_size: 11.0,
                            ..default()
                        },
