...
/// デフォルトのエディタを登録
pub fn register_default_component_editors(mut registry: bevy::prelude::ResMut<crate::ui::inspector::component_editor_registry::ComponentEditorRegistry>) {
    ...
    registry.register::<bevy::prelude::MeshMaterial3d<bevy::pbr::StandardMaterial>>(Box::new(MeshMaterial3dEditor));
