...
/// Mesh3dエディタの実装
pub struct Mesh3dEditor;

impl ComponentEditor for Mesh3dEditor {
    fn draw_ui(
        &self,
        ...
        commands.entity(parent_ui).with_children(|parent: &mut ChildSpawnerCommands| {
            parent.spawn((
                ...
                Name::new("Mesh3dEditor"),
                BackgroundColor(Color::srgb(0.18, 0.18, 0.18)),
            )).with_children(|mesh_editor: &mut ChildSpawnerCommands| {
                mesh_editor.spawn((
                    Node {
                        width: Val::Percent(100.0),
                        height: Val::Px(25.0),
