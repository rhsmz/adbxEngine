...
impl ComponentEditor for SpriteEditor {
            ...
            .with_children(|parent: &mut ChildSpawnerCommands| {
                parent
                    .spawn((
                        ...
                        Name::new("SpriteEditor"),
                        BackgroundColor(Color::srgb(0.18, 0.18, 0.18)),
                    ))
                    .with_children(|sprite_editor: &mut ChildSpawnerCommands| {
                        sprite_editor
                            .spawn((
                                Node {
                                    width: Val::Percent(100.0),
