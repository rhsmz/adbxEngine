...
pub fn draw_position_fields(
    ...
    parent.spawn((
        ...
        for (axis, val, field_type) in [
            ("X", transform.translation.x, TransformFieldType::TranslationX),
            ("Y", transform.translation.y, TransformFieldType::TranslationY),
            ("Z", transform.translation.z, TransformFieldType::TranslationZ),
        ].iter() {
