#[cfg(feature = "ai")]
use crate::ui::code_editor::{AiRequest, AiRequestType, AiResponse};
...
pub async fn generate_with_openai_async(
    ...
    let system_message = match request.request_type {
        ...
        AiRequestType::Complete => {
            "You are a helpful coding assistant. Complete the code based on the user's request."
        }
        AiRequestType::Refactor => {
            "You are a helpful coding assistant. Refactor the code based on the user's request."
        }
        AiRequestType::Explain => {
            "You are a helpful coding assistant. Explain the code based on the user's request."
        }
    };
