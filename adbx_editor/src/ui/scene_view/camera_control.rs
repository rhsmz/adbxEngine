...
pub fn handle_scene_view_input(
    ...
    camera_query_for_viewport: Query<
    ...
    if is_in_scene_view {
        for event in mouse_wheel_events.read() {
            ...
            scene_view.orbit_distance = (scene_view.orbit_distance - zoom_delta).clamp(1.0, 100.0);
        }
    }
    ...
    let camera_position = scene_view.orbit_target
        + Vec3::new(
