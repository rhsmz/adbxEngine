...
use super::javascript_keywords::{get_javascript_functions, get_javascript_keywords};
use super::lua_keywords::{get_lua_functions, get_lua_keywords};
use super::python_keywords::{get_python_functions, get_python_keywords};
use super::rust_keywords::{get_rust_functions, get_rust_keywords};
...
pub fn get_completion_candidates(
    ...
    // 現在のファイルから関数名や変数名を抽出
    candidates.extend(extract_identifiers_from_content(
        content,
        prefix,
        cursor_position,
    ));
