...
pub fn get_lua_keywords(prefix: &str) -> Vec<CompletionCandidate> {
    let keywords = vec![
        ...
        "break", "return", "local", "nil", "true", "false", "and", "or", "not", "in", "pairs",
        "ipairs", "next", "type", "tostring", "tonumber", "print",
    ];
...
pub fn get_lua_functions(prefix: &str) -> Vec<CompletionCandidate> {
    let functions = vec![
        ...
        (
            "tonumber",
            "tonumber(value)",
            "function tonumber(value) -> number | nil",
            "Converts a value to a number",
        ),
        (
            "pairs",
            "pairs(table)",
            "function pairs(table) -> iterator",
            "Returns an iterator for all key-value pairs",
        ),
        (
            "ipairs",
            "ipairs(table)",
            "function ipairs(table) -> iterator",
            "Returns an iterator for array elements",
        ),
        (
            "next",
            "next(table, key)",
            "function next(table, key) -> key, value",
            "Returns the next key-value pair",
        ),
        (
            "getmetatable",
            "getmetatable(object)",
            "function getmetatable(object) -> table | nil",
            "Returns the metatable of an object",
        ),
        (
            "setmetatable",
            "setmetatable(object, metatable)",
            "function setmetatable(object, metatable) -> object",
