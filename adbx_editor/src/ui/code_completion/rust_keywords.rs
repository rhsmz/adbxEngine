...
pub fn get_rust_keywords(prefix: &str) -> Vec<CompletionCandidate> {
    let keywords = vec![
        ...
        "trait", "where", "if", "else", "match", "for", "while", "loop", "break", "continue",
        "return", "self", "Self", "super", "crate", "async", "await", "move", "ref", "dyn",
        "unsafe", "extern", "type", "as", "in", "true", "false", "None", "Some", "Ok", "Err",
        "Result", "Option", "Box", "Vec", "String", "str", "u8", "u16", "u32", "u64", "u128", "i8",
        "i16", "i32", "i64", "i128", "f32", "f64", "bool", "char", "usize", "isize",
    ];
